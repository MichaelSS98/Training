...
import { UPDATE_EMPLOYEE, GET_EMPLOYEES } from '../../../queries/Employees';
...
const EmployeeUpdateModal = ({popupUpdate, setPopupUpdate, employeeInfo}) => {
    ...
    const [updateEmployee] = useMutation(UPDATE_EMPLOYEE, {
        update(cache, {data}) {
            ...
            const newEmployees = existingEmployees.getEmployees.map(e => {
              if (e.id === employeeId)
    ...
    const initialValues = {
        name: employeeInfo[0],
        adress: employeeInfo[2],
        email: employeeInfo[3],
        hire_date: customDateDisplay(new Date(employeeInfo[4])),
        project_id: employeeInfo[5],
        salary: employeeInfo[6].toString(),
        job_title: employeeInfo[7]
    };
                    ...
                    {(props) => (
                        <View style={styles.container}>
                            <ScrollView showsVerticalScrollIndicator={false}>
                                <Text style={styles.header}>PLEASE UPDATE THE FOLLOWING INFORMATION</Text>
                                <TextInput 
